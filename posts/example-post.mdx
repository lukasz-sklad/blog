---
title: Jak tworzyć symbole ikon gotowe do SVG w programie Sketch PART 2
...
# h1 Heading to samo ```<h1>...</h1>```


## h2 Heading to samo ```<h2>...</h2>```

### h3 Heading to samo ```<h3>...</h3>```

#### h4 Heading to samo ```<h4>...</h4>```

##### h5 Heading to samo ```<h5>...</h5>```

###### h6 Heading to samo ```<h6>...</h6>```
...
_This is italic text_  ```<i>```

_This is italic text_  ```<em>```
