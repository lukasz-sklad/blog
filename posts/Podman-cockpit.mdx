...
<https://play.google.com/store/apps/details?id=pro.archiemeng.waifu2x&hl=pl&gl=US>

Linki (pomoce) do podmana i cockpitu

<https://cockpit-project.org/running>

<https://develmonk.com/2020/06/27/add-podman-controller-to-cockpit-on-ubuntu-20-04-lts/>